...
ALTER TABLE "de_tai"
ADD FOREIGN KEY ("id_tai_khoan_de_xuat") REFERENCES "tai_khoan" ("id");

ALTER TABLE "thuoc_ve"
ADD FOREIGN KEY ("id_de_tai") REFERENCES "de_tai" ("id");

ALTER TABLE "thuoc_ve"
ADD FOREIGN KEY ("id_hoc_ky") REFERENCES "hoc_ky" ("id");

ALTER TABLE "nhom_tieu_chi"
ADD FOREIGN KEY ("id_mau_danh_gia") REFERENCES "mau_danh_gia" ("id");

ALTER TABLE "tieu_chi"
ADD FOREIGN KEY ("id_nhom_tieu_chi") REFERENCES "nhom_tieu_chi" ("id");

ALTER TABLE "lich_trinh"
ADD FOREIGN KEY ("id_nguoi_them") REFERENCES "giao_vu" ("id_tai_khoan");
...
ALTER TABLE "hoi_dong"
ADD FOREIGN KEY ("id_nguoi_lap") REFERENCES "giang_vien" ("id_tai_khoan");

ALTER TABLE "danh_gia"
ADD FOREIGN KEY ("id_hoi_dong") REFERENCES "hoi_dong" ("id");

ALTER TABLE "danh_gia"
ADD FOREIGN KEY ("id_de_tai") REFERENCES "de_tai" ("id");

ALTER TABLE "phan_bien"
ADD FOREIGN KEY ("id_giang_vien") REFERENCES "giang_vien" ("id_tai_khoan");
...
ADD FOREIGN KEY ("id_nhiem_vu") REFERENCES "nhiem_vu" ("id");

ALTER TABLE "tai_lieu"
ADD FOREIGN KEY ("id_thuc_hien") REFERENCES "thuc_hien" ("id");

ALTER TABLE "tai_lieu"
ADD FOREIGN KEY ("id_bao_cao") REFERENCES "bao_cao" ("id");

ALTER TABLE "bao_cao"
ADD FOREIGN KEY ("id_sinh_vien") REFERENCES "sinh_vien" ("id_tai_khoan");

ALTER TABLE "bao_cao"
ADD FOREIGN KEY ("id_de_tai") REFERENCES "de_tai" ("id");

ALTER TABLE "nhiem_vu"
ADD FOREIGN KEY ("id_nguoi_them") REFERENCES "giang_vien" ("id_tai_khoan");

ALTER TABLE "nhiem_vu"
ADD FOREIGN KEY ("id_de_tai") REFERENCES "de_tai" ("id");

ALTER TABLE "giao_vu"
ADD FOREIGN KEY ("id_tai_khoan") REFERENCES "tai_khoan" ("id");
...
ALTER TABLE "duyet_de_tai"
ADD FOREIGN KEY ("id_nguoi_duyet") REFERENCES "giang_vien" ("id_tai_khoan");

ALTER TABLE "duyet_de_tai"
ADD FOREIGN KEY ("id_de_tai") REFERENCES "de_tai" ("id");

ALTER TABLE "moi_quan_tam"
ADD FOREIGN KEY ("id_sinh_vien") REFERENCES "sinh_vien" ("id_tai_khoan");

ALTER TABLE "moi_quan_tam"
ADD FOREIGN KEY ("id_chu_de") REFERENCES "chu_de" ("id");

ALTER TABLE "moi_lien_quan"
ADD FOREIGN KEY ("id_de_tai") REFERENCES "de_tai" ("id");
...
ALTER TABLE "cham_diem"
ADD FOREIGN KEY ("id_tieu_chi") REFERENCES "tieu_chi" ("id");
...
ADD FOREIGN KEY ("id_nguoi_nhan") REFERENCES "tai_khoan" ("id");

ALTER TABLE "tuong_tac"
ADD FOREIGN KEY ("id_thong_bao") REFERENCES "thong_bao" ("id");